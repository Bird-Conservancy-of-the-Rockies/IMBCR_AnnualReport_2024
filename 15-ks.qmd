...
# KS-BCR18-RV is a special value from the heddlr_loop.qmd file
x <- which(data$stratum == "KS-BCR18-RV")
...
# KS-BCR19-PL is a special value from the heddlr_loop.qmd file
x <- which(data$stratum == "KS-BCR19-PL")
...
# KS-BCR19-RV is a special value from the heddlr_loop.qmd file
x <- which(data$stratum == "KS-BCR19-RV")
